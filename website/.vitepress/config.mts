  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      { text: 'Understand the system', items: [
        ...
        { text: 'Mercury vault deployment', link: '/reference/mercury-deployment' },
        { text: 'Scheduled report emails', link: '/reference/scheduled-reports' },
      ] },
      { text: 'Reference', collapsed: false, items: [
        ...
        { text: 'Wiki API & search', link: '/reference/wiki' },
        { text: 'Streaming summary API', link: '/reference/summaries' },
