...
## Keys and envelopes`);
  ...
  docs["docs/llms.txt"] += "\n- /docs/wiki.md: Persistent capability wikis, agent client, revision API, search, comments, attachment downloads, video playback and streaming ZIP exports up to 1 GiB.\n";
